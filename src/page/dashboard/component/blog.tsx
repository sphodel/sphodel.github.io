...
const INSERT_POST=gql(`mutation InsertPost($content: String = "", $classify: String = "", $summary: String = "", $tag: String = "", $title: String = "", $user_id: String = "") {
      ...
      <div className={"bg-[#F7F7F7]"}>
        <div className={"pt-11 m-auto pb-8"} style={{ maxWidth: "1140px" }}>
          ...
          <div className={"mt-8 p-5 h-48 bg-white"}>
            ...
            <div
              className={"py-4 border border-transparent border-b-[#F7F7F7]"}
            >
